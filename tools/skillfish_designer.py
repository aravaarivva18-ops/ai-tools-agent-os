...
class SkillfishDesigner:
    ...
    def run_usability_scorer(
        self, tasks_completed: int, total_tasks: int, seconds_taken: float
    ) -> dict[str, Any]:
    ...
    def run_design_critique(
        self, component_name: str, has_contrast: bool, has_aria: bool
    ) -> dict[str, Any]:
