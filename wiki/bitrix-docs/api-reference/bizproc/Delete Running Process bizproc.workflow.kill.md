...
tags:
  ...
  - api
  - docs
title: "Delete Running Process bizproc.workflow.kill"
original_path: "api-reference/bizproc/bizproc-workflow-kill.md"
---
...
|| `400` | `ERROR_WRONG_WORKFLOW_ID` | Empty workflow instance ID | Empty value was passed to the `ID` parameter ||
|#
