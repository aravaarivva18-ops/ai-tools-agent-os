...
tags:
  ...
  - api
  - docs
title: "Update Action bizproc.activity.update"
original_path: "api-reference/bizproc/bizproc-activity/bizproc-activity-update.md"
---
...
`type` | **Description** ||
|| **result** 
[`boolean`](../../data-types.md) | Returns `true` if the action is successfully updated ||
|| **time** 
