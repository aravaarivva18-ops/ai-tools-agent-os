...
tags:
  ...
  - api
  - docs
title: "Get the participation status of the current user in the event calendar.meeting.status.get"
original_path: "api-reference/calendar/calendar-event/calendar-meeting-status-get.md"
---
