...
tags:
  ...
  - api
  - docs
title: "Set Participation Status in Event for Current User calendar.meeting.status.set"
original_path: "api-reference/calendar/calendar-event/calendar-meeting-status-set.md"
---
