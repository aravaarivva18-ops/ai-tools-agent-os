...
tags:
  ...
  - api
  - docs
title: "Get Fields for catalog.extra.getFields"
original_path: "api-reference/catalog/extra/catalog-extra-get-fields.md"
---

# Get Fields for catalog.extra.getFields
...
The method returns the fields for markup.
...
- PHP
    ...
    try {
        ...
        echo 'Error getting extra fields: ' . $e->getMessage();
    }
    ```
