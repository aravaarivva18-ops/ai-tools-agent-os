...
tags:
  ...
  - api
  - docs
title: "Delete Measurement Unit catalog.measure.delete"
original_path: "api-reference/catalog/measure/catalog-measure-delete.md"
---
...
- JS (TS)
    ...
    try {
      ...
      if (!response.isSuccess) {
        ...
        console.info('Measurement deleted:', result)
      }
    } catch (error) {
...
`type` | **Description** ||
|| **result**
[`boolean`](../../data-types.md) | Result of the measurement unit deletion ||
|| **time**
