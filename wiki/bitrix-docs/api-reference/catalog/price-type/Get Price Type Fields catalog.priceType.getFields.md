...
tags:
  ...
  - api
  - docs
title: "Get Price Type Fields catalog.priceType.getFields"
original_path: "api-reference/catalog/price-type/catalog-price-type-get-fields.md"
---
...
- cURL (Webhook)
    ...
    -d '{}' \
    https://**put_your_bitrix24_address**/rest/**put_your_user_id_here**/**put_your_webhook_here**/catalog.priceType.getFields
    ```
...
|| **priceType**
[`object`](../../data-types.md) | Object in the format `{"field_1": "value_1", ... "field_N": "value_N"}`, where `field` is the identifier of the object [catalog_price_type](../data-types.md#catalog_price_type), and `value` is an object of type [rest_field_description](../data-types.md#rest_field_description) ||
|| **time**
