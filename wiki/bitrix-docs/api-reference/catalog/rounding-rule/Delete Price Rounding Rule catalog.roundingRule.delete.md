...
tags:
  ...
  - api
  - docs
title: "Delete Price Rounding Rule catalog.roundingRule.delete"
original_path: "api-reference/catalog/rounding-rule/catalog-rounding-rule-delete.md"
---
...
- cURL (Webhook)
    ...
    -d '{"id":1}' \
    https://**put_your_bitrix24_address**/rest/**put_your_user_id_here**/**put_your_webhook_here**/catalog.roundingRule.delete
    ```
...
`type` | **Description** ||
|| **result**
[`boolean`](../../data-types.md) | Result of deleting the price rounding rule ||
|| **time**
