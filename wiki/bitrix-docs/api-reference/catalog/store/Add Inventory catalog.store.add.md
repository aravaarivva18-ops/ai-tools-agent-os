...
tags:
  ...
  - api
  - docs
title: "Add Inventory catalog.store.add"
original_path: "api-reference/catalog/store/catalog-store-add.md"
---
...
`type` | **Description** ||
|| **fields***
[`object`](../../data-types.md)| Field values for adding the inventory ([detailed description](#fields)) ||
|#
...
`type` | **Description** ||
|| **address***
[`string`](../../data-types.md) | Inventory address ||
|| **title**
[`string`](../../data-types.md) | Inventory name ||
|| **active**
...
To remove the image, use an object in the format `{remove: ‘Y’}` ||
|| **dateModify**
...
- PHP
    ...
    try {
        ...
        echo 'Error adding inventory: ' . $e->getMessage();
    }
    ```
...
|| **store**
[`catalog_store`](../data-types.md#catalog_store) | Object with information about the added inventory ||
|| **time**
...
#|
|| **Code** | **Description** ||
|| `200040300020` | Insufficient rights to create inventory ||
