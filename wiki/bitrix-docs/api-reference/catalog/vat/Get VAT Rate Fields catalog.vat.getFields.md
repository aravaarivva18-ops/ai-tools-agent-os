...
tags:
  ...
  - api
  - docs
title: "Get VAT Rate Fields catalog.vat.getFields"
original_path: "api-reference/catalog/vat/catalog-vat-get-fields.md"
---
...
- PHP
    ...
    try {
        ...
        echo 'Error getting VAT fields: ' . $e->getMessage();
    }
    ```
