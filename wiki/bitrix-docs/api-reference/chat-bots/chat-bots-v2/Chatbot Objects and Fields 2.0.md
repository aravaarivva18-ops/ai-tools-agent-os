...
tags:
  ...
  - api
  - docs
title: "Chatbot Objects and Fields 2.0"
original_path: "api-reference/chat-bots/chat-bots-v2/entities.md"
---
...
Description of objects returned in the responses of the `im.v2` and `imbot.v2` methods, as well as in event data and webhook notifications.

> Quick navigation: [User](#user) | [Bot](#bot) | [Chat](#chat) | [Message](#message) | [File](#file) | [Command](#command)

Field types depend on the context:

— In method responses and FETCH events `Event.get`, types are preserved as is.
...
|| **externalAuthId**
[`string`](../../data-types.md) | Type of external authorization: `default`, `bot`, `email`, `replica`, and others ||
|| **status**
...
|| **messageType**
[`string`](../../data-types.md) | Internal type: `C` (chat), `O` (open), `P` (private), and others ||
|| **owner**
...
Fields that are returned in method responses (e.g., [imbot.v2.Chat.get](./imbot.v2/chats/chat-get.md)), but not passed in events.
...
|| **title**
[`string`](../../data-types.md) | Title of the command in Bitrix24 language. Only in method responses ||
|| **params**
[`string`](../../data-types.md) | Description of command parameters in Bitrix24 language. Only in method responses ||
|| **category**
