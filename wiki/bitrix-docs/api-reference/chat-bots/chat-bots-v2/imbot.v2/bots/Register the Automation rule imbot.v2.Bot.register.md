...
tags:
  ...
  - api
  - docs
title: "Register the Automation rule imbot.v2.Bot.register"
original_path: "api-reference/chat-bots/chat-bots-v2/imbot.v2/bots/bot-register.md"
---
...
`Type` | **Description** || 
|| **fields*** 
[`object`](../../../../data-types.md) | Object with bot parameters. Parameter descriptions — [below](#fields) || 
|#
...
`Type` | **Description** || 
|| **code*** 
[`string`](../../../../data-types.md) | Unique code of the bot within the application || 
|| **botToken** 
...
As of 06.08.2026, tokens longer than 40 characters will be **rejected** with the error `BOT_TOKEN_INVALID_LENGTH`. If you are using a long token — update it via [imbot.v2.Bot.update](./bot-update.md) before this date.

{% endnote %} ||
|| **properties*** 
[`object`](../../../../data-types.md) | Properties of the bot's profile. Parameter descriptions — [below](#properties) || 
|| **type** 
[`string`](../../../../data-types.md) | Type of the bot. Description of types and their behavior — [Bot Types](../../index.md#bot-types).
...
|| **isHidden** 
[`boolean`](../../../../data-types.md) | Hidden bot. Allowed values: `true`, `false`. Default `false` || 
|| **isReactionsEnabled** 
[`boolean`](../../../../data-types.md) | Enable support for reactions. Allowed values: `true`, `false`. Default `true` || 
|| **isSupportOpenline** 
[`boolean`](../../../../data-types.md) | Enable support for Open Channels. Allowed values: `true`, `false`. Default `false` || 
|| **backgroundId** 
[`string`](../../../../data-types.md) | Background of the bot's chat. Default `null` — uses the background from user settings. Available values — in [backgrounds table](#backgrounds). Invalid values are normalized to `null` || 
|#
...
If not specified — assigned automatically || 
|| **gender** 
...
|| **countChat** 
[`integer`](../../../../data-types.md) | Number of chats of the bot || 
|| **countUser** 
[`integer`](../../../../data-types.md) | Number of users interacted with the bot || 
|#
...
|| **connector** 
[`boolean`](../../../../data-types.md) | User is connected via connector || 
|| **externalAuthId** 
