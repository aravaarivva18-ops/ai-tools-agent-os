...
tags:
  ...
  - api
  - docs
title: "Leave Chat imbot.v2.Chat.leave"
original_path: "api-reference/chat-bots/chat-bots-v2/imbot.v2/chats/chat-leave.md"
---
...
- cURL (Webhook)
    ...
    curl -X POST \
      ...
      https://**put_your_bitrix24_address**/rest/**put_your_user_id_here**/**put_your_webhook_here**/imbot.v2.Chat.leave
    ```
...
- cURL (OAuth)
    ...
    curl -X POST \
      ...
      https://**put_your_bitrix24_address**/rest/imbot.v2.Chat.leave
    ```
...
- JS
    ...
    ```js
    try {
      const response = await $b24.callMethod('imbot.v2.Chat.leave', {
        botId: 456,
        dialogId: 'chat5',
      });
