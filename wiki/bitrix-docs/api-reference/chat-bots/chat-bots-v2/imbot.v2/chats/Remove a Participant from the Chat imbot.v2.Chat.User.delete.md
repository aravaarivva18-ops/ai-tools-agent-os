...
tags:
  ...
  - api
  - docs
title: "Remove a Participant from the Chat imbot.v2.Chat.User.delete"
original_path: "api-reference/chat-bots/chat-bots-v2/imbot.v2/chats/chat-user-delete.md"
---
...
- cURL (Webhook)
    ...
    curl -X POST \
      ...
      https://**put_your_bitrix24_address**/rest/**put_your_user_id_here**/**put_your_webhook_here**/imbot.v2.Chat.User.delete
    ```
...
- cURL (OAuth)
    ...
    curl -X POST \
      ...
      https://**put_your_bitrix24_address**/rest/imbot.v2.Chat.User.delete
    ```
...
- JS
    ...
    ```js
    try {
      const response = await $b24.callMethod('imbot.v2.Chat.User.delete', {
        botId: 456,
        dialogId: 'chat5',
        userId: 1,
      });
