...
tags:
  ...
  - api
  - docs
title: "Remove the imbot.v2.Command.unregister Command"
original_path: "api-reference/chat-bots/chat-bots-v2/imbot.v2/commands/command-unregister.md"
---
...
The method `imbot.v2.Command.unregister` removes the bot's slash command.
...
|| `COMMAND_NOT_FOUND` | Command not found | Command not found or access denied ||
|#
