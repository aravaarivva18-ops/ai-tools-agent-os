...
tags:
  ...
  - api
  - docs
title: "Get a Link to Download the File imbot.v2.File.download"
original_path: "api-reference/chat-bots/chat-bots-v2/imbot.v2/files/file-download.md"
---
...
The method `imbot.v2.File.download` returns a link to download a file from the chat.
