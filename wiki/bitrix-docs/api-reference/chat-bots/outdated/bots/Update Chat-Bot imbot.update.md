...
tags:
  ...
  - api
  - docs
title: "Update Chat-Bot imbot.update"
original_path: "api-reference/chat-bots/outdated/bots/imbot-update.md"
---
...
Development of this method has been halted. Please use [imbot.v2.Bot.update](../../chat-bots-v2/imbot.v2/bots/bot-update.md).
...
`Type` | **Description** ||
|| **BOT_ID***
[`integer`](../../../data-types.md) | The identifier of the chat-bot. You can obtain the identifier using the [imbot.bot.list](./imbot-bot-list.md) method. The value must be greater than `0` ||
|| **FIELDS***
[`object`](../../../data-types.md) | Data for updating the chat-bot. The structure of the object is described in detail [below](#fields) ||
|| **CLIENT_ID**
...
`Type` | **Description** ||
|| **CODE**
[`string`](../../../data-types.md) | New string code for the bot, unique within Bitrix24 ||
|| **EVENT_HANDLER**
...
|| **PROPERTIES**
[`object`](../../../data-types.md) | Properties of the chat-bot profile. The structure of the object is described in detail [below](#fields-properties) ||
|#
...
`Type` | **Description** ||
|| **NAME**
[`string`](../../../data-types.md) | The name of the chat-bot. If both values `NAME` and `LAST_NAME` are provided, they must not be empty at the same time ||
|| **LAST_NAME**
[`string`](../../../data-types.md) | The last name of the chat-bot. If both values `NAME` and `LAST_NAME` are provided, they must not be empty at the same time ||
|| **COLOR**
...
|| `EVENT_MESSAGE_ADD_ERROR` | Wrong handler URL | An invalid URL for the `EVENT_MESSAGE_ADD` handler was provided ||
|| `EVENT_MESSAGE_UPDATE_ERROR` | Wrong handler URL | An invalid URL for the `EVENT_MESSAGE_UPDATE` handler was provided ||
|| `EVENT_MESSAGE_DELETE_ERROR` | Wrong handler URL | An invalid URL for the `EVENT_MESSAGE_DELETE` handler was provided ||
|| `EVENT_WELCOME_MESSAGE_ERROR` | Wrong handler URL | An invalid URL for the `EVENT_WELCOME_MESSAGE` handler was provided ||
|| `EVENT_BOT_DELETE_ERROR` | Wrong handler URL | An invalid URL for the `EVENT_BOT_DELETE` handler was provided ||
|| `NAME_ERROR` | Bot name isn't specified | Both fields `NAME` and `LAST_NAME` in `PROPERTIES` were provided as empty ||
