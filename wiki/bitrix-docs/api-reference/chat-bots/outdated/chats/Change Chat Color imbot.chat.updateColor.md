...
tags:
  ...
  - api
  - docs
title: "Change Chat Color imbot.chat.updateColor"
original_path: "api-reference/chat-bots/outdated/chats/imbot-chat-update-color.md"
---
...
- `GRAPHITE` — graphite ||
|| **BOT_ID**
[`integer`](../../../data-types.md) | The identifier of the chat bot. You can obtain the bot identifier using the method [imbot.bot.list](../bots/imbot-bot-list.md).
