...
tags:
  ...
  - api
  - docs
title: "Event Triggered by Chat Bot Command ONIMCOMMANDADD"
original_path: "api-reference/chat-bots/outdated/commands/events/on-im-command-add.md"
---
...
>
> Who can subscribe: users of the application that registered the chat bot

{% note warning "DEPRECATED" %}

The development of this event has been halted. Please use [ONIMBOTV2COMMANDADD](../../../chat-bots-v2/imbot.v2/events/events.md#onimbotv2commandadd).
...
|| **status**
[`string`](../../../../data-types.md) | Application state indicator on the account ||
|| **client_endpoint**
...
|| **COMMAND**
[`string`](../../../../data-types.md) | Character code of the invoked command ||
|| **COMMAND_ID**
...
- `KEYBOARD` — command invoked by a keyboard button ||
|| **MESSAGE_ID**
...
|| **CHAT_AVATAR**
[`string`](../../../../data-types.md) | Identifier of the chat avatar. `0` means no avatar set. This parameter depends on the chat type and is absent in personal dialogs ||
|| **CHAT_COLOR**
[`string`](../../../../data-types.md) | Color scheme of the chat. This parameter depends on the chat type and is absent in personal dialogs ||
|| **CHAT_ENTITY_TYPE**
[`string`](../../../../data-types.md) | Type of the object to which the chat is linked. This parameter depends on the chat type and is absent in personal dialogs ||
|| **CHAT_ENTITY_ID**
[`string`](../../../../data-types.md) | Identifier of the object to which the chat is linked. This parameter depends on the chat type and is absent in personal dialogs ||
|| **CHAT_ENTITY_DATA_1**
[`string`](../../../../data-types.md) | Additional data of the chat object — field 1. This parameter depends on the chat type and is absent in personal dialogs ||
|| **CHAT_ENTITY_DATA_2**
[`string`](../../../../data-types.md) | Additional data of the chat object — field 2. This parameter depends on the chat type and is absent in personal dialogs ||
|| **CHAT_ENTITY_DATA_3**
[`string`](../../../../data-types.md) | Additional data of the chat object — field 3. This parameter depends on the chat type and is absent in personal dialogs ||
|| **CHAT_EXTRANET**
[`string`](../../../../data-types.md) | Indicator of an extranet chat: `Y` or `N`. This parameter depends on the chat type and is absent in personal dialogs ||
|| **CHAT_PREV_MESSAGE_ID**
[`integer`](../../../../data-types.md) | Identifier of the previous message in the chat. This parameter depends on the chat type and is absent in personal dialogs ||
|| **CHAT_CAN_POST**
[`string`](../../../../data-types.md) | Permission of the current user to send messages in the chat. This parameter depends on the chat type and is absent in personal dialogs ||
|| **RID**
[`integer`](../../../../data-types.md) | Identifier of the record of the user's relation to the chat. This parameter depends on the chat type and is absent in personal dialogs ||
|| **IS_MANAGER**
