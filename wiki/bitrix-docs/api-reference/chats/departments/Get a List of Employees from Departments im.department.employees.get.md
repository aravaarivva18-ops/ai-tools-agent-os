...
tags:
  ...
  - api
  - docs
title: "Get a List of Employees from Departments im.department.employees.get"
original_path: "api-reference/chats/departments/im-department-employees-get.md"
---
...
- when `USER_DATA = 'Y'` contains an array of objects describing users [(detailed description)](#user-object) ||
|| **time**
