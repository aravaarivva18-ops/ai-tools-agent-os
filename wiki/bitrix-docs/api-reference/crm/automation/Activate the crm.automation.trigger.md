...
tags:
  ...
  - api
  - docs
title: "Activate the crm.automation.trigger"
original_path: "api-reference/crm/automation/crm-automation-trigger.md"
---
...
- JS (TS)
    ...
    try {
      ...
      if (!response.isSuccess) {
        ...
        console.info('Trigger activated:', result)
      }
    } catch (error) {
...
- JS (UMD)
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', triggerAutomation)
    </script>
    ```
...
- Python
    ...
    try:
        bitrix_response = client.crm.automation.trigger(
            target="DEAL_57",
            code="c5u4m",
        ).response
