...
tags:
  ...
  - api
  - docs
title: "Get the list of call statuses crm.calllist.statuslist"
original_path: "api-reference/crm/call-list/crm-calllist-statuslist.md"
---
...
- Python
    ...
    try:
        bitrix_response = client.crm.calllist.statuslist().response
