...
tags:
  ...
  - api
  - docs
title: "Get a list of custom fields for companies crm.company.userfield.list"
original_path: "api-reference/crm/companies/userfields/crm-company-userfield-list.md"
---
...
- are multiple,
- are mandatory,
- have custom field labels in German. By filtering with the `LANG` parameter, we will additionally receive field names in the response.
