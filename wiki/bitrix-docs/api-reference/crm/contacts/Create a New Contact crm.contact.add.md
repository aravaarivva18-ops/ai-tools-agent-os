...
tags:
  ...
  - api
  - docs
title: "Create a New Contact crm.contact.add"
original_path: "api-reference/crm/contacts/crm-contact-add.md"
---
...
`type` | **Description** ||
|| **result**
[`integer`][1] | The root element of the response, contains the identifier of the created contact ||
|| **time**
