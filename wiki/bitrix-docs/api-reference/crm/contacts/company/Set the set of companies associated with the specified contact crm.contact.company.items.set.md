...
tags:
  ...
  - api
  - docs
title: "Set the set of companies associated with the specified contact crm.contact.company.items.set"
original_path: "api-reference/crm/contacts/company/crm-contact-company-items-set.md"
---
