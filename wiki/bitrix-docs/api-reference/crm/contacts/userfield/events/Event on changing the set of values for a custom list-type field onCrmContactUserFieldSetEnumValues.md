...
tags:
  ...
  - api
  - docs
title: "Event on changing the set of values for a custom list-type field onCrmContactUserFieldSetEnumValues"
original_path: "api-reference/crm/contacts/userfield/events/on-crm-contact-user-field-set-enum-values.md"
---
