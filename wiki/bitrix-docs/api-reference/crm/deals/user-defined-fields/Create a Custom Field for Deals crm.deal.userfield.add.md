...
tags:
  ...
  - api
  - docs
title: "Create a Custom Field for Deals crm.deal.userfield.add"
original_path: "api-reference/crm/deals/user-defined-fields/crm-deal-userfield-add.md"
---
    ...
    try:
        bitrix_response = client.crm.deal.userfield.add(
            fields={
                ...
                "MANDATORY": "N",
                "SHOW_FILTER": "Y",
                "EDIT_FORM_LABEL": {"en": "Deal comment"},
                "LIST_COLUMN_LABEL": {"en": "Deal comment"},
                "LIST_FILTER_LABEL": {"en": "Deal comment"},
            },
        ).response
