...
tags:
  ...
  - api
  - docs
title: "Delete Custom Field for Leads crm.lead.userfield.delete"
original_path: "api-reference/crm/leads/userfield/crm-lead-userfield-delete.md"
---
...
`type` | **Description** ||
|| **result**
[`boolean`](../../../data-types.md) | Root element of the response, contains `true` if successful ||
|| **time**
