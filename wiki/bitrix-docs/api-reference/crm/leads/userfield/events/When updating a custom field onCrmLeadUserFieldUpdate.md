...
tags:
  ...
  - api
  - docs
title: "When updating a custom field onCrmLeadUserFieldUpdate"
original_path: "api-reference/crm/leads/userfield/events/on-crm-lead-user-field-update.md"
---
...
The event `ONCRMLEADUSERFIELDUPDATE` will trigger when a custom field for leads is updated.
...
In this case — `ONCRMLEADUSERFIELDUPDATE` ||
|| **event_handler_id**
