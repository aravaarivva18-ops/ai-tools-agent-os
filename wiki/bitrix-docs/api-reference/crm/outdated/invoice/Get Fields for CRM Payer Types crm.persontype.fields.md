...
tags:
  ...
  - api
  - docs
title: "Get Fields for CRM Payer Types crm.persontype.fields"
original_path: "api-reference/crm/outdated/invoice/crm-person-type-fields.md"
---
...
- PHP
    ...
    try {
        ...
        echo 'Error fetching person type fields: ' . $e->getMessage();
    }
    ```
