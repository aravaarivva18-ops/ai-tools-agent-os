...
tags:
  ...
  - api
  - docs
title: "Get a List of Custom Fields for crm.quote.userfield.list"
original_path: "api-reference/crm/quote/user-field/crm-quote-user-field-list.md"
---
...
- cURL (Webhook)
    ...
    https://**put_your_bitrix24_address**/rest/**put_your_user_id_here**/**put_your_webhook_here**/crm.quote.userfield.list
    ```
