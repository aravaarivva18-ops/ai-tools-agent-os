...
tags:
  ...
  - api
  - docs
title: "Get Description of Address Fields crm.address.fields"
original_path: "api-reference/crm/requisites/addresses/crm-address-fields.md"
---
...
- Python
    ...
    try:
        bitrix_response = client.crm.address.fields().response
