...
tags:
  ...
  - api
  - docs
title: "Event on changing the set of values for a custom list-type field onCrmRequisiteUserFieldSetEnumValues"
original_path: "api-reference/crm/requisites/events/on-crm-requisite-user-field-set-enum-values.md"
---
