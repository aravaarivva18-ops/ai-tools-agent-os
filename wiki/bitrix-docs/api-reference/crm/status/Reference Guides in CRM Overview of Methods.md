...
tags:
  ...
  - api
  - docs
title: "Reference Guides in CRM: Overview of Methods"
original_path: "api-reference/crm/status/index.md"
---
...
* [Deals](../deals/index.md) — `DEAL_STAGE` for the main direction of deals and `DEAL_STAGE_xx` for additional ones, where xx is the ID of the direction.
