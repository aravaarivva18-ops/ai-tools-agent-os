...
tags:
  ...
  - api
  - docs
title: "Add System Activity crm.activity.add"
original_path: "api-reference/crm/timeline/activities/activity-base/crm-activity-add.md"
---
...
`type` | **Description** ||
|| **fields***
[`array`](../../../../data-types.md) | An array of values for the [activity fields](#fields) in the following structure:
...
- JS (TS)
    ...
    try {
      ...
      if (!response.isSuccess) {
        ...
        console.info('Created activity ID:', result)
      }
    } catch (error) {
