...
tags:
  ...
  - api
  - docs
title: "Update System CRM Activity crm.activity.update"
original_path: "api-reference/crm/timeline/activities/activity-base/crm-activity-update.md"
---
...
- JS (TS)
    ...
    try {
      ...
      if (!response.isSuccess) {
        ...
        console.info('Activity updated successfully:', result)
      }
    } catch (error) {
