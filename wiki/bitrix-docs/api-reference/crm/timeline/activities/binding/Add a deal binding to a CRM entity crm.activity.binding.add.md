...
tags:
  ...
  - api
  - docs
title: "Add a deal binding to a CRM entity crm.activity.binding.add"
original_path: "api-reference/crm/timeline/activities/binding/crm-activity-binding-add.md"
---
...
- JS (TS)
    ...
    try {
      ...
      if (!response.isSuccess) {
        ...
        console.info('Binding added:', result)
      }
    } catch (error) {
...
- JS (UMD)
    ...
    <script>
      async function addActivityBinding() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', addActivityBinding)
    </script>
    ```
...
- Python
    ...
    try:
        bitrix_response = client.crm.activity.binding.add(
            activity_id=999,
            entity_type_id=2,
            entity_id=101,
        ).response
