...
tags:
  ...
  - api
  - docs
title: "Delete Badge by Code crm.activity.badge.delete"
original_path: "api-reference/crm/timeline/activities/configurable/badges/crm-activity-badge-delete.md"
---
...
- JS (TS)
    ...
    try {
      ...
      if (!response.isSuccess) {
        ...
        console.info('Badge deleted:', result)
      }
    } catch (error) {
...
- JS (UMD)
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', deleteBadge)
    </script>
    ```
