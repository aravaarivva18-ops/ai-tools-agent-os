...
tags:
  ...
  - api
  - docs
title: "Get Badge Information by Code crm.activity.badge.get"
original_path: "api-reference/crm/timeline/activities/configurable/badges/crm-activity-badge-get.md"
---
...
- JS (TS)
    ...
    try {
      const response = await $b24.actions.v2.call.make<BadgeGetResult>({
...
- JS (UMD)
    ...
    <script>
      async function getActivityBadge() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', getActivityBadge)
    </script>
    ```
