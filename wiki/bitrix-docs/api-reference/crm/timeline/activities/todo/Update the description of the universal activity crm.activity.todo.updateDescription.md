...
tags:
  ...
  - api
  - docs
title: "Update the description of the universal activity crm.activity.todo.updateDescription"
original_path: "api-reference/crm/timeline/activities/todo/crm-activity-todo-update-description.md"
---
...
- JS (TS)
    ...
    try {
      const response = await $b24.actions.v2.call.make<UpdateDescriptionResult>({
        method: 'crm.activity.todo.updateDescription',
        params: {
          id: 999,
          ownerTypeId: 2,
          ownerId: 1,
      ...
      if (!response.isSuccess) {
        ...
        console.info('Updated todo ID:', result.id)
      }
    } catch (error) {
...
- JS (UMD)
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', updateTodoDescription)
    </script>
    ```
...
- Python
    ...
    try:
        bitrix_response = client.crm.activity.todo.update_description(
            bitrix_id=999,
            owner_type_id=2,
            owner_id=101,
            value="Prepare contract draft",
        ).response
