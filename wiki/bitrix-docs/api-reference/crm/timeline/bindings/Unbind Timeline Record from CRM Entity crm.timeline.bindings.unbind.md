...
tags:
  ...
  - api
  - docs
title: "Unbind Timeline Record from CRM Entity crm.timeline.bindings.unbind"
original_path: "api-reference/crm/timeline/bindings/crm-timeline-bindings-unbind.md"
---
...
- JS (TS)
    ...
    try {
      const response = await $b24.actions.v2.call.make<boolean>({
        method: 'crm.timeline.bindings.unbind',
        params: {
          fields: {
            OWNER_ID: 1110,
            ENTITY_ID: 10,
...
- JS (UMD)
    ...
    <script>
      async function unbindTimelineBinding() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', unbindTimelineBinding)
    </script>
    ```
