...
tags:
  ...
  - api
  - docs
title: "Delete a Set of Additional Content Blocks for the Timeline Record crm.timeline.layout.blocks.delete"
original_path: "api-reference/crm/timeline/layout-blocks/crm-timeline-layout-blocks-delete.md"
---
...
- JS (TS)
    ...
    type DeleteTimelineLayoutBlocksResult = {
      success: boolean
    }

    try {
      const response = await $b24.actions.v2.call.make<DeleteTimelineLayoutBlocksResult>({
        method: 'crm.timeline.layout.blocks.delete',
        params: {
          entityTypeId: 2, // Deal
          entityId: 4,     // Deal ID
          timelineId: 8,   // Timeline entry ID attached to this deal
        },
...
- JS (UMD)
    ...
    <script>
      async function deleteTimelineLayoutBlocks() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', deleteTimelineLayoutBlocks)
    </script>
    ```
