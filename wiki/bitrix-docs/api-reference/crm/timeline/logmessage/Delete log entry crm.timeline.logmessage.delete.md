...
tags:
  ...
  - api
  - docs
title: "Delete log entry crm.timeline.logmessage.delete"
original_path: "api-reference/crm/timeline/logmessage/crm-timeline-logmessage-delete.md"
---
...
- JS (TS)
    ...
    try {
      const response = await $b24.actions.v2.call.make<boolean>({
        method: 'crm.timeline.logmessage.delete',
        params: {
          id: 1,
        },
      ...
      if (!response.isSuccess) {
        ...
        console.info('Log message deleted:', result)
      }
    } catch (error) {
...
- JS (UMD)
    ...
    <script>
      async function deleteTimelineLogMessage() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', deleteTimelineLogMessage)
    </script>
    ```
