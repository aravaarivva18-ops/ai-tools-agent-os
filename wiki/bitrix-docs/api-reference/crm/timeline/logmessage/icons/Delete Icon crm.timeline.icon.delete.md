...
tags:
  ...
  - api
  - docs
title: "Delete Icon crm.timeline.icon.delete"
original_path: "api-reference/crm/timeline/logmessage/icons/crm-timeline-icon-delete.md"
---
...
- JS (TS)
    ...
    try {
      ...
      if (!response.isSuccess) {
        ...
        console.info('Icon deleted:', result)
      }
    } catch (error) {
...
- JS (UMD)
    ...
    <script>
      async function deleteTimelineIcon() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', deleteTimelineIcon)
    </script>
    ```
