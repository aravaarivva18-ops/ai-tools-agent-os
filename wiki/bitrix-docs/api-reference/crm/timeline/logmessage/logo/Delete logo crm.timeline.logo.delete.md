...
tags:
  ...
  - api
  - docs
title: "Delete logo crm.timeline.logo.delete"
original_path: "api-reference/crm/timeline/logmessage/logo/crm-timeline-logo-delete.md"
---
...
- JS (TS)
    ...
    try {
      ...
      if (!response.isSuccess) {
        ...
        console.info('Logo deleted:', result)
      }
    } catch (error) {
...
- JS (UMD)
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', deleteLogo)
    </script>
    ```
