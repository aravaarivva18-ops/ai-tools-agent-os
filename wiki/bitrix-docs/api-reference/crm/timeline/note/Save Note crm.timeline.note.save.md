...
tags:
  ...
  - api
  - docs
title: "Save Note crm.timeline.note.save"
original_path: "api-reference/crm/timeline/note/crm-timeline-note-save.md"
---
...
- JS (TS)
    ...
    try {
      ...
      if (!response.isSuccess) {
        ...
        console.info('Note saved:', result)
      }
    } catch (error) {
...
- JS (UMD)
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', saveTimelineNote)
    </script>
    ```
