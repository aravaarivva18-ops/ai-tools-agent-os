...
tags:
  ...
  - api
  - docs
title: "Update User Field userfieldconfig.update"
original_path: "api-reference/crm/universal/userfieldconfig/userfieldconfig-update.md"
---
...
|| **settings** 
[`object`](../../../data-types.md) | Additional field settings. See [Parameter settings](#settings).
