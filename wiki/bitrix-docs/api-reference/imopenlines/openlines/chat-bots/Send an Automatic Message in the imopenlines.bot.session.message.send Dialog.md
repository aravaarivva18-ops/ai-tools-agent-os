...
tags:
  ...
  - api
  - docs
title: "Send an Automatic Message in the imopenlines.bot.session.message.send Dialog"
original_path: "api-reference/imopenlines/openlines/chat-bots/imopenlines-bot-session-message-send.md"
---
