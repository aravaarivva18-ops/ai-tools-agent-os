...
tags:
  ...
  - api
  - docs
title: "Update Message Delivery Status messageservice.message.status.update"
original_path: "api-reference/messageservice/messageservice-message-status-update.md"
---
