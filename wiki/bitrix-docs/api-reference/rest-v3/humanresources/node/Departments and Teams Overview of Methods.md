...
tags:
  ...
  - api
  - docs
title: "Departments and Teams: Overview of Methods"
original_path: "api-reference/rest-v3/humanresources/node/index.md"
---
...
4. If working with a hierarchy, get the `parentId` of the parent department or team through [humanresources.node.list](./humanresources-node-list.md) or [humanresources.node.get](./humanresources-node-get.md), and then request child departments and teams through [humanresources.node.children](./humanresources-node-children.md).
...
6. Change the properties of a department or team using the method [humanresources.node.edit](./humanresources-node-edit.md) or move them to a new parent using the method [humanresources.node.move](./humanresources-node-move.md).
...
- [Create and edit a department in the company structure](https://helpdesk.bitrix24.com/open/23599408/)
- [Cross-functional teams in Bitrix24](https://helpdesk.bitrix24.com/open/25609471/)
- [Add a department to a chat, channel, or collab in Bitrix24](https://helpdesk.bitrix24.com/open/25442614/)
- [Configure access permissions to the company structure](https://helpdesk.bitrix24.com/open/23580546/)
...
|| [humanresources.node.field.list](./humanresources-node-field-list.md) | Returns a list of fields of a department or team ||
|| [humanresources.node.field.get](./humanresources-node-field-get.md) | Returns the description of a field of a department or team ||
|#
