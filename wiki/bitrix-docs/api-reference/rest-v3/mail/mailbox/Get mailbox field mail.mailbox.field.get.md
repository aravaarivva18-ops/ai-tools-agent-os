...
tags:
  ...
  - api
  - docs
title: "Get mailbox field mail.mailbox.field.get"
original_path: "api-reference/rest-v3/mail/mailbox/mail-mailbox-field-get.md"
---

# Get mailbox field mail.mailbox.field.get
...
The `mail.mailbox.field.get` method returns the description of a mailbox field by name.
...
|| **select**
[`array`](../../../data-types.md) | A list of description fields that should be returned in the response.
...
`https://{installation_address}/rest/api/{user_id}/{webhook_token}/mail.mailbox.field.get`
...
- cURL (Webhook)
    ...
    https://**put_your_bitrix24_address**/rest/api/**put_your_user_id_here**/**put_your_webhook_here**/mail.mailbox.field.get
    ```
...
|| **item**
[`object`](../../../data-types.md) | Field description object. The response structure depends on `select` ||
|| **time**
