...
tags:
  ...
  - api
  - docs
title: "Get a list of employees mail.recipient.listemployees"
original_path: "api-reference/rest-v3/mail/recipient/mail-recipient-listemployees.md"
---

# Get a list of employees mail.recipient.listemployees
...
The `mail.recipient.listemployees` method searches for employees by name or email.
...
`type` | **Description** ||
|| **query***
[`string`](../../../data-types.md) | Search string by employee name or email.

At least one character must be specified ||
|| **pagination**
[`object`](../../../data-types.md) | Pagination parameters:
- `page` — page number
- `limit` — number of records per page, default `50`, maximum `200`
...
`https://{installation_address}/rest/api/{user_id}/{webhook_token}/mail.recipient.listemployees`
...
- cURL (Webhook)
    ...
    -d '{"query":"John","pagination":{"page":1,"limit":20,"offset":0}}' \
...
- cURL (OAuth)
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"query":"John","pagination":{"page":1,"limit":20,"offset":0},"auth":"**put_access_token_here**"}' \
...
|| **items**
[`array`](../../../data-types.md) | Array of employee objects ||
|| **items[]**
[`object`](../../../data-types.md) | Employee object ||
|| **id**
[`integer`](../../../data-types.md) | Employee identifier ||
|| **email**
[`string`](../../../data-types.md) | Employee email ||
|| **name**
...
```json
{
    "error": {
        ...
        "validation": [
            {
                "message": "Mandatory field `query` is missing",
                "field": "query"
            }
        ]
    }
...
#|
|| **Field** | **Error description** | **How to fix** ||
|| `query` | Required field `query` is not specified | Provide `query` in the request body ||
|#
