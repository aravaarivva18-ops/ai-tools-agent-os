...
tags:
  ...
  - api
  - docs
title: "Get recipient field mail.recipient.field.get"
original_path: "api-reference/rest-v3/mail/recipient/mail-recipient-field-get.md"
---

# Get recipient field mail.recipient.field.get
...
The `mail.recipient.field.get` method retrieves the description of a recipient field by name.
...
`type` | **Description** ||
|| **name***
[`string`](../../../data-types.md) | Name of the field whose description is to be retrieved.
...
- `name` — recipient name ||
|| **select**
[`array`](../../../data-types.md) | List of description fields to be returned in the response.
...
`https://{installation_address}/rest/api/{user_id}/{webhook_token}/mail.recipient.field.get`
...
- cURL (Webhook)
    ...
    -d '{"name":"email","select":["name","type","title"]}' \
    https://**put_your_bitrix24_address**/rest/api/**put_your_user_id_here**/**put_your_webhook_here**/mail.recipient.field.get
    ```
...
- cURL (OAuth)
    ...
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -d '{"name":"email","select":["name","type","title"],"auth":"**put_access_token_here**"}' \
...
|| **item**
[`object`](../../../data-types.md) | Object containing the field description. The response structure depends on `select` ||
|| **time**
...
- [{#T}](./mail-recipient-field-list.md)
- [{#T}](./index.md)
