...
tags:
  ...
  - api
  - docs
title: "Get Task File Field Description tasks.task.file.field.get"
original_path: "api-reference/rest-v3/tasks/tasks-task-file-field-get.md"
---
...
`https://{installation_address}/rest/api/{user_id}/{webhook_token}/tasks.task.file.field.get`
...
- [{#T}](./tasks-task-file-field-list.md)
