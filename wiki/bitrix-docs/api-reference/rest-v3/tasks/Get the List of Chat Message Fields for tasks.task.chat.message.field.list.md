...
tags:
  ...
  - api
  - docs
title: "Get the List of Chat Message Fields for tasks.task.chat.message.field.list"
original_path: "api-reference/rest-v3/tasks/tasks-task-chat-message-field-list.md"
---
