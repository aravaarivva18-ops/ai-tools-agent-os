...
tags:
  ...
  - api
  - docs
title: "Delete Cashbox Handler sale.cashbox.handler.delete"
original_path: "api-reference/sale/cashbox/sale-cashbox-handler-delete.md"
---
...
If there are cashboxes linked to the handler, it will not be deleted — you must first remove the cashboxes.
