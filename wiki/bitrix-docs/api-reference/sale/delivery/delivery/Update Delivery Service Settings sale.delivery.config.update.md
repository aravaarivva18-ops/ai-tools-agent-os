...
tags:
  ...
  - api
  - docs
title: "Update Delivery Service Settings sale.delivery.config.update"
original_path: "api-reference/sale/delivery/delivery/sale-delivery-config-update.md"
---
...
```json
{
   ...
   "time":{
      ...
      "date_start":"2024-04-26T15:25:19+02:00",
      "date_finish":"2024-04-26T15:25:20+02:00"
   }
}
```
...
|| `ACCESS_DENIED` | Insufficient rights to update the delivery service settings | 403 ||
|#
