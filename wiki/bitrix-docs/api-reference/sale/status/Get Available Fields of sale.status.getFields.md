...
tags:
  ...
  - api
  - docs
title: "Get Available Fields of sale.status.getFields"
original_path: "api-reference/sale/status/sale-status-get-fields.md"
---

# Get Available Fields of sale.status.getFields
...
The `sale.status.getFields` method returns the available fields of statuses.
