...
tags:
  ...
  - api
  - docs
title: "Defer a Task to the Status "Deferred" tasks.task.defer"
original_path: "api-reference/tasks/tasks-task-defer.md"
---

# Defer a Task to the Status "Deferred" tasks.task.defer
