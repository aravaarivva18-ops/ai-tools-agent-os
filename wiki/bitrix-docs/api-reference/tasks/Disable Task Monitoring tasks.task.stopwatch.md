...
tags:
  ...
  - api
  - docs
title: "Disable Task Monitoring tasks.task.stopwatch"
original_path: "api-reference/tasks/tasks-task-stop-watch.md"
---
...
The method `tasks.task.stopwatch` disables monitoring for the task.
...
|| `0` | wrong task id | The value of `taskId` parameter is of incorrect type ||
