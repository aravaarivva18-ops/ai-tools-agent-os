...
tags:
  ...
  - api
  - docs
title: "Enable Task Watching with tasks.task.startwatch"
original_path: "api-reference/tasks/tasks-task-start-watch.md"
---
...
The method `tasks.task.startwatch` enables watching a task.
...
- cURL (Webhook)
    ...
    -d '{"taskId":8017}' \
    https://**put_your_bitrix24_address**/rest/**put_your_user_id_here**/**put_your_webhook_here**/tasks.task.startwatch
    ```
...
- PHP
    ...
    try {
        ...
        echo 'Error starting task watch: ' . $e->getMessage();
    }
    ```
...
```json
{
    "result": {
        "task": {
            ...
            "responsibleId": "503",
            "changedBy": "503",
            "changedDate": "2025-09-10T17:22:12+02:00",
            "statusChangedBy": "503",
            "closedBy": "0",
            "closedDate": null,
            ...
            "exchangeId": null,
            "outlookVersion": "52",
            "viewedDate": "2025-09-10T17:22:13+02:00",
            "sorting": null,
            "durationFact": "1166",
            "isMuted": "N",
            "isPinned": "N",
        ...
        "time": {
            "start": 1757514132.671783,
            "finish": 1757514133.47723,
            "duration": 0.8054471015930176,
            "processing": 0.7846410274505615,
            "date_start": "2025-09-10T17:22:12+02:00",
            "date_finish": "2025-09-10T17:22:13+02:00",
            "operating_reset_at": 1757514732,
            "operating": 0.7846250534057617
        }
    }
}
```
