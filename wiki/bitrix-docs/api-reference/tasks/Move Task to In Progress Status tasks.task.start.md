...
tags:
  ...
  - api
  - docs
title: "Move Task to In Progress Status tasks.task.start"
original_path: "api-reference/tasks/tasks-task-start.md"
---

# Move Task to In Progress Status tasks.task.start
...
The method `tasks.task.start` moves the task to the In Progress status.
