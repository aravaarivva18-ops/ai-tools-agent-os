...
tags:
  ...
  - api
  - docs
title: "Pin a Task: tasks.task.pin"
original_path: "api-reference/tasks/tasks-task-pin.md"
---
...
- cURL (Webhook)
    ...
    -d '{"id":3897}' \
    https://**put_your_bitrix24_address**/rest/**put_your_user_id_here**/**put_your_webhook_here**/tasks.task.pin
    ```
...
- PHP
    ...
    try {
        ...
        echo 'Error pinning task: ' . $e->getMessage();
    }
    ```
