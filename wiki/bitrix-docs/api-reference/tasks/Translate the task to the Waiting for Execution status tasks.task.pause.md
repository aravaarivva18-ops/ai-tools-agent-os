...
tags:
  ...
  - api
  - docs
title: "Translate the task to the Waiting for Execution status tasks.task.pause"
original_path: "api-reference/tasks/tasks-task-pause.md"
---

# Translate the task to the Waiting for Execution status tasks.task.pause
...
- no permission to perform the action on the task ||
|#
