...
tags:
  ...
  - api
  - docs
title: "Add Attachments from Drive to Checklist Item tasks.template.checklist.addAttachmentsFromDisk"
original_path: "api-reference/tasks/template/checklist/tasks-template-checklist-add-attachments-from-disk.md"
---
