...
tags:
  ...
  - api
  - docs
title: "Add Checklist Item to Task Template tasks.template.checklist.add"
original_path: "api-reference/tasks/template/checklist/tasks-template-checklist-add.md"
---
