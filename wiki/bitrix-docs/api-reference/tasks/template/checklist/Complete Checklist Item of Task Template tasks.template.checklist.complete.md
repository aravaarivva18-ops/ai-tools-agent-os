...
tags:
  ...
  - api
  - docs
title: "Complete Checklist Item of Task Template tasks.template.checklist.complete"
original_path: "api-reference/tasks/template/checklist/tasks-template-checklist-complete.md"
---
...
|| `400` | `0` | Bitrix\Tasks\CheckList\CheckListFacade::onAfterUpdate(): Argument #1 ($taskId) must be of type int, string given, called in /var/www/html/bitrix/modules/tasks/lib/checklist/checklistfacade.php on line 313 | Empty or incorrect type for `templateId` ||
|| `400` | `0` | Incorrect value [] for field [ENTITY_ID] in item [, ] | Non-existent, empty, or incorrect type for `checkListItemId` ||
