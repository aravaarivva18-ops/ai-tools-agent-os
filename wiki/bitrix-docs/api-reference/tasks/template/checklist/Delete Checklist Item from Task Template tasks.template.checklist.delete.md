...
tags:
  ...
  - api
  - docs
title: "Delete Checklist Item from Task Template tasks.template.checklist.delete"
original_path: "api-reference/tasks/template/checklist/tasks-template-checklist-delete.md"
---
