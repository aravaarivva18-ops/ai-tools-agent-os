...
tags:
  ...
  - api
  - docs
title: "Remove Attachments from Checklist Item tasks.template.checklist.removeAttachments"
original_path: "api-reference/tasks/template/checklist/tasks-template-checklist-remove-attachments.md"
---
