...
tags:
  ...
  - api
  - docs
title: "Get a List of Custom Fields task.item.userfield.getlist"
original_path: "api-reference/tasks/user-field/task-item-user-field-get-list.md"
---
...
- `UF_MAIL_MESSAGE` — with Mail messages
- `UF_TASK_WEBDAV_FILES` — with Drive files

These are created based on custom fields, which is why they appear in the list. More details about task relationships with other objects can be found in the article [Tasks: Overview of Methods](../index.md).
...
|| **SETTINGS**
[`object`](../../data-types.md) | Additional field settings, composition depends on the type `USER_TYPE_ID` ||
|#
