...
tags:
  ...
  - api
  - docs
title: "Change Text in the Call Card Center via CallCardSetStatusText Application"
original_path: "api-reference/widgets/ui-interaction/page-background-worker/call-card-set-status-text.md"
---
...
- JS (TS)
    ...
    try {
      ...
      if (!response.isSuccess) {
        ...
        console.info('Status text updated successfully, result:', result)
      }
    } catch (error) {
...
- JS (UMD)
    ...
    <script>
      async function setCallCardStatusText() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', setCallCardStatusText)
    </script>
    ```
