...
tags:
  ...
  - api
  - docs
title: "Evaluating Call Quality with BackgroundCallCard::qualityMeterClick"
original_path: "api-reference/widgets/ui-interaction/page-background-worker/events/quality-meter-click.md"
---
...
- JS (TS)
    ...
    try {
      ...
      if (!response.isSuccess) {
        ...
        console.info('Subscription registered:', result)
      }
    } catch (error) {
...
- JS (UMD)
    ...
    <script>
      async function bindQualityMeterClickHandler() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', bindQualityMeterClickHandler)
    </script>
    ```
