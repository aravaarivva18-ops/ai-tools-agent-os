...
tags:
  ...
  - api
  - docs
title: "On Clicking the Close Button of the Call Card BackgroundCallCard::closeButtonClick"
original_path: "api-reference/widgets/ui-interaction/page-background-worker/events/close-button-click.md"
---
...
For this event — `BackgroundCallCard::closeButtonClick` ||
|| **HANDLER***
...
- JS (UMD)
    ...
    <script>
      async function bindCloseButtonClickEvent() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', bindCloseButtonClickEvent)
    </script>
    ```
