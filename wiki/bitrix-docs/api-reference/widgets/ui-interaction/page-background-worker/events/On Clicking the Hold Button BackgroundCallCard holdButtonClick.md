...
tags:
  ...
  - api
  - docs
title: "On Clicking the Hold Button BackgroundCallCard::holdButtonClick"
original_path: "api-reference/widgets/ui-interaction/page-background-worker/events/hold-button-click.md"
---
...
- JS (UMD)
    ...
    <script>
      async function bindHoldButtonClickEvent() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', bindHoldButtonClickEvent)
    </script>
    ```
