...
tags:
  ...
  - api
  - docs
title: "On Clicking the Mute Button of BackgroundCallCard::muteButtonClick"
original_path: "api-reference/widgets/ui-interaction/page-background-worker/events/mute-button-click.md"
---
...
- JS (UMD)
    ...
    <script>
      async function bindMuteButtonClick() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', bindMuteButtonClick)
    </script>
    ```
