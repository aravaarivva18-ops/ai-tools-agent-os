...
tags:
  ...
  - api
  - docs
title: "On Clicking the "Notify Admin" Button: BackgroundCallCard::notifyAdminButtonClick"
original_path: "api-reference/widgets/ui-interaction/page-background-worker/events/notify-admin-button-click.md"
---

# On Clicking the "Notify Admin" Button: BackgroundCallCard::notifyAdminButtonClick
...
The event `BackgroundCallCard::notifyAdminButtonClick` is triggered when a request to notify the administrator is made from the call card.
...
For this event — `BackgroundCallCard::notifyAdminButtonClick` ||
|| **HANDLER***
...
- cURL (OAuth)
    ...
    -d '{"PLACEMENT":"BackgroundCallCard::notifyAdminButtonClick","HANDLER":"**your_handler_url_here**"}' \
