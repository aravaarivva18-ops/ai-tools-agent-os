...
tags:
  ...
  - api
  - docs
title: "On Clicking the "Redirect" Button: BackgroundCallCard::completeTransferButtonClick"
original_path: "api-reference/widgets/ui-interaction/page-background-worker/events/complete-transfer-button-click.md"
---
...
The event `BackgroundCallCard::completeTransferButtonClick` is triggered when the call transfer is confirmed.
...
For this event — `BackgroundCallCard::completeTransferButtonClick` ||
|| **HANDLER***  
