...
tags:
  ...
  - api
  - docs
title: "On Clicking the "Reply" Button: BackgroundCallCard::answerButtonClick"
original_path: "api-reference/widgets/ui-interaction/page-background-worker/events/answer-button-click.md"
---
...
The event `BackgroundCallCard::answerButtonClick` is triggered when an incoming call is accepted.
...
For this event — `BackgroundCallCard::answerButtonClick` ||
|| **HANDLER***
...
- JS (UMD)
    ...
    <script>
      async function bindAnswerButtonClickEvent() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', bindAnswerButtonClickEvent)
    </script>
    ```
