...
tags:
  ...
  - api
  - docs
title: "When pressing one of the numeric buttons on the phone, BackgroundCallCard::dialpadButtonClick"
original_path: "api-reference/widgets/ui-interaction/page-background-worker/events/dialpad-button-click.md"
---
...
- JS (UMD)
    ...
    <script>
      async function bindDialpadButtonClick() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', bindDialpadButtonClick)
    </script>
    ```
