...
tags:
  ...
  - api
  - docs
title: "When selecting an operator to whom the current operator wants to transfer the call BackgroundCallCard::transferButtonClick"
original_path: "api-reference/widgets/ui-interaction/page-background-worker/events/transfer-button-click.md"
---
...
- JS (UMD)
    ...
    <script>
      async function bindTransferButtonClick() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', bindTransferButtonClick)
    </script>
    ```
