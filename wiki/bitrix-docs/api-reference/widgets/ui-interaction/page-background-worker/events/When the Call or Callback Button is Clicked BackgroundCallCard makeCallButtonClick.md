...
tags:
  ...
  - api
  - docs
title: "When the "Call" or "Callback" Button is Clicked: BackgroundCallCard::makeCallButtonClick"
original_path: "api-reference/widgets/ui-interaction/page-background-worker/events/make-call-button-click.md"
---
...
- JS (UMD)
    ...
    <script>
      async function bindCallButtonClickEvent() {
        try {
      ...
      document.addEventListener('DOMContentLoaded', bindCallButtonClickEvent)
    </script>
    ```
