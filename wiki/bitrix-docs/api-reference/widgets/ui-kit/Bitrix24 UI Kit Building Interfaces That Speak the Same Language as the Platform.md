...
tags:
  ...
  - api
  - docs
title: "Bitrix24 UI Kit: Building Interfaces That Speak the Same Language as the Platform"
original_path: "api-reference/widgets/ui-kit/index.md"
---
...
- **Quick Start.** Connect the UI Kit and immediately gain access to buttons, modal windows, forms, tabs, lists, and dozens of other components.
...
- **Reliability.** UI Kit components are constantly used and tested—this means fewer bugs, fewer CSS hacks, and more confidence in the outcome.
