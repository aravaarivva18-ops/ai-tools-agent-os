...
tags:
  ...
  - api
  - docs
title: "Installation and Usage of B24JsSDK"
original_path: "sdk/b24jssdk/index.md"
---
...
3. Formats REST API data into corresponding JavaScript types (numbers, IBAN invoices, dates, etc.);
...
- For generating and server-side rendering applications in Node.js and Nuxt;
...
Once included, the library will be accessible via the global variable `B24Js`. Here’s an example of initialization:
...
- [Interaction of the widget with the messenger input field](./iframe-messenger-textarea.md)