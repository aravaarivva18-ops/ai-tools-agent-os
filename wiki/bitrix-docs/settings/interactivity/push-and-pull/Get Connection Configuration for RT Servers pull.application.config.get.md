...
tags:
  ...
  - api
  - docs
title: "Get Connection Configuration for RT Servers pull.application.config.get"
original_path: "settings/interactivity/push-and-pull/pull-application-config-get.md"
---
